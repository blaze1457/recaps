...
function onSaveCompany(){
	name = $('#nameInput').val();
	established = $('#establishedInput').val();
	employees = $('#employeesInput').val();
...
function onResetCompany(){
	$('#nameInput').val(resetValues.name);
	$('#establishedInput').val(resetValues.established);
	$('#employeesInput').val(resetValues.employees);
	$('#revenueInput').val(resetValues.revenue); 
}
